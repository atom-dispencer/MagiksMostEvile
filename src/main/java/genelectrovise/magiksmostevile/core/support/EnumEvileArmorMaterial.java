...
public enum EnumEvileArmorMaterial implements IArmorMaterial {
  ...
  AMETHYST(MagiksMostEvile.MODID + ":" + "amethyst", 25, new int[] {3, 5, 4, 2}, 50,
      SoundEvents.ARMOR_EQUIP_DIAMOND, 1.0F, () -> {
        return Ingredient.of(EvileItemTags.AMETHYST);
      }, 0),
  // Powered amethyst
  POWERED_AMETHYST(MagiksMostEvile.MODID + ":" + "powered_amethyst", 33, new int[] {4, 6, 5, 3},
      100, SoundEvents.ARMOR_EQUIP_DIAMOND, 2.0F, () -> {
        return Ingredient.of(EvileItemTags.POWERED_AMETHYST);
      }, 0),
  // Over powered amethyst
  OVER_POWERED_AMETHYST(MagiksMostEvile.MODID + ":" + "over_powered_amethyst", 40,
      new int[] {5, 7, 6, 4}, 150, SoundEvents.ARMOR_EQUIP_DIAMOND, 3.0F, () -> {
        return Ingredient.of(EvileItemTags.OVER_POWERED_AMETHYST);
      }, 0);
