...
public class TheKrakenModel extends EntityModel<TheKrakenEntity> {
	...
	private final ModelRenderer beak_west;
	private final ModelRenderer beak_east;
	...
	public TheKrakenModel() {
		...
		beak_west = new ModelRenderer(this);
		beak_west.setRotationPoint(0.0F, 0.0F, 0.0F);
		beak.addChild(beak_west);
		beak_west.setTextureOffset(128, 266).addBox(1.0F, -2.0F, -3.0F, 2.0F, 5.0F, 1.0F, 0.0F, false);

		beak_east = new ModelRenderer(this);
		beak_east.setRotationPoint(0.0F, 0.0F, 0.0F);
		beak.addChild(beak_east);
		beak_east.setTextureOffset(128, 266).addBox(-3.0F, -2.0F, -3.0F, 2.0F, 5.0F, 1.0F, 0.0F, false);
