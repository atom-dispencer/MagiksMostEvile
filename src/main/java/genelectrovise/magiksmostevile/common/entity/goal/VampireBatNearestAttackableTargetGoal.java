 ...
 */
public class VampireBatNearestAttackableTargetGoal<T extends LivingEntity> extends NearestAttackableTargetGoal<T> {
	 ...
	 * @param checkSight
	 */
	public VampireBatNearestAttackableTargetGoal(VampireBatEntity goalOwnerIn, Class<T> targetClassIn, boolean checkSight) {
