...
public enum EnumEvileItemTier implements IItemTier {
	...
	private EnumEvileItemTier(int harvestLevelIn, int maxUsesIn, float efficiencyIn, float attackDamageIn,
...
//+++++++++++++++++++++++++++++++++++++++_EVILE_ITEM_TAGS_++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	public static class EvileItemTags {
		private static TagCollection<Item> evile_itemtag_collection = new TagCollection<>((p_203643_0_) -> {
