...
public class AltarNetworkingManager {
	...
	public static void onCommonSetupEvent(FMLCommonSetupEvent event) {
		...
		CAltarCastButton = NetworkRegistry.newSimpleChannel(RLCastButtonPressed, () -> CAST_BUTTON_PRESSED_MESSAGE_PROTOCOL_VERSION, AltarCastButtonPressedMessageHandlerOnClient::isProtocolAccepted, AltarCastButtonPressedMessageHandlerOnServer::isProtocolAccepted);
		CAltarCastButton.registerMessage(ALTAR_CAST_BUTTON_PRESSED_TO_SERVER, AltarCastButtonPressedMessageToServer.class, AltarCastButtonPressedMessageToServer::encode, AltarCastButtonPressedMessageToServer::decode, AltarCastButtonPressedMessageHandlerOnServer::onMessageReceived);
