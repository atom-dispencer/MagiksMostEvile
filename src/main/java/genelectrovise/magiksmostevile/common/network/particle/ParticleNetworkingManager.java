...
public class ParticleNetworkingManager {
	...
	public static final ResourceLocation RLEnderParticle = new ResourceLocation(MagiksMostEvile.MODID, "ender_particle");
	...
	public static final ResourceLocation RLEnergyTransfer = new ResourceLocation(MagiksMostEvile.MODID, "energy_transfer");
	...
	public static void onCommonSetupEvent(FMLCommonSetupEvent event) {
		...
		CEnderParticle = NetworkRegistry.newSimpleChannel(RLEnderParticle, () -> ENDER_PARTICLE_MESSAGE_PROTOCOL_VERSION, EnderParticleMessageHandlerOnClient::isProtocolAccepted, EnderParticleMessageHandlerOnServer::isProtocolAccepted);
		CEnderParticle.registerMessage(ENDER_PARTICLE_TO_SERVER, EnderParticleMessageToServer.class, EnderParticleMessageToServer::encode, EnderParticleMessageToServer::decode, EnderParticleMessageHandlerOnServer::onMessageReceived);
		CEnderParticle.registerMessage(ENDER_PARTICLE_TO_CLIENT, EnderParticleMessageToClient.class, EnderParticleMessageToClient::encode, EnderParticleMessageToClient::decode, EnderParticleMessageHandlerOnClient::onMessageReceived);
		
		CTransferEnergy = NetworkRegistry.newSimpleChannel(RLEnergyTransfer, () -> TRANSFER_ENERGY_MESSAGE_PROTOCOL_VERSION, TransferEnergyMessageHandlerOnClient::isProtocolAccepted, TransferEnergyMessageHandlerOnServer::isProtocolAccepted);
		CTransferEnergy.registerMessage(TRANSFER_ENERGY_TO_SERVER, TransferEnergyMessageToServer.class, TransferEnergyMessageToServer::encode, TransferEnergyMessageToServer::decode, TransferEnergyMessageHandlerOnServer::onMessageReceived);
		CTransferEnergy.registerMessage(TRANSFER_ENERGY_TO_CLIENT, TransferEnergyMessageToClient.class, TransferEnergyMessageToClient::encode, TransferEnergyMessageToClient::decode, TransferEnergyMessageHandlerOnClient::onMessageReceived);
	}
