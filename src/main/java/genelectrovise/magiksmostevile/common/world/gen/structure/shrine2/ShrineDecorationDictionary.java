...
public class ShrineDecorationDictionary extends StructureDecorationDictionary {
	...
	private final BlockWeightPair INFESTED_CRACKED_STONE_BRICKS = new BlockWeightPair(Blocks.INFESTED_CRACKED_STONE_BRICKS, 7);
	private final BlockWeightPair INFESTED_COBBLESTONE = new BlockWeightPair(Blocks.INFESTED_COBBLESTONE, 4);
	private final BlockWeightPair CHISLED_STONE_BRICKS = new BlockWeightPair(Blocks.CHISELED_STONE_BRICKS, 3);
	private final BlockWeightPair INFESTED_MOSSY_STONE_BRICKS = new BlockWeightPair(Blocks.INFESTED_MOSSY_STONE_BRICKS, 6);
	private final BlockWeightPair AIR = new BlockWeightPair(Blocks.AIR, 1);

	// Cobblestone
	private final BlockWeightPair MOSSY_COBBLESTONE = new BlockWeightPair(Blocks.MOSSY_COBBLESTONE, 1);
	...
	// Stone brick wall
	private final BlockWeightPair STONE_BRICK_WALL = new BlockWeightPair(Blocks.MOSSY_STONE_BRICK_WALL, 2);
	private final BlockWeightPair MOSSY_STONE_BRICK_WALL = new BlockWeightPair(Blocks.MOSSY_STONE_BRICK_WALL, 1);
	private final BlockWeightPair MOSSY_COBBLESTONE_WALL = new BlockWeightPair(Blocks.MOSSY_COBBLESTONE_WALL, 1);
	...
	public ShrineDecorationDictionary(Random random, Biome biome, IWorld world) {
		...
		add(Blocks.COBBLESTONE, new BlockReplacementList(random).addPair(MOSSY_COBBLESTONE).addPair(STONE_BRICKS).addPair(STONE));
		add(Blocks.STONE_BRICK_WALL, new BlockReplacementList(random).addPair(STONE_BRICK_WALL).addPair(MOSSY_STONE_BRICK_WALL).addPair(MOSSY_COBBLESTONE_WALL));
