...
public class EvileArmorBases {
	...
	public static class AmethystArmorBase extends ArmorItem {
		...
		public void onArmorTick(ItemStack stack, World world, PlayerEntity player) {
			if (player.inventory.armorItemInSlot(0) != null && player.inventory.armorItemInSlot(1) != null && player.inventory.armorItemInSlot(2) != null && player.inventory.armorItemInSlot(3) != null) {
				if (player.inventory.armorItemInSlot(3).getItem() == EvileDeferredRegistry.AMETHYST_HELMET.get() && player.inventory.armorItemInSlot(2).getItem() == EvileDeferredRegistry.AMETHYST_CHESTPLATE.get() && player.inventory.armorItemInSlot(1).getItem() == EvileDeferredRegistry.AMETHYST_LEGGINGS.get()
	...
	public static class PoweredAmethystArmorBase extends ArmorItem {
		...
		public void onArmorTick(ItemStack stack, World world, PlayerEntity player) {
			if (player.inventory.armorItemInSlot(0) != null && player.inventory.armorItemInSlot(1) != null && player.inventory.armorItemInSlot(2) != null && player.inventory.armorItemInSlot(3) != null) {
				if (player.inventory.armorItemInSlot(3).getItem() == EvileDeferredRegistry.POWERED_AMETHYST_HELMET.get() && player.inventory.armorItemInSlot(2).getItem() == EvileDeferredRegistry.POWERED_AMETHYST_CHESTPLATE.get() && player.inventory.armorItemInSlot(1).getItem() == EvileDeferredRegistry.POWERED_AMETHYST_LEGGINGS.get()
	...
	public static class OverPoweredAmethystArmorBase extends ArmorItem {
		...
		public void onArmorTick(ItemStack stack, World world, PlayerEntity player) {
			if (player.inventory.armorItemInSlot(0) != null && player.inventory.armorItemInSlot(1) != null && player.inventory.armorItemInSlot(2) != null && player.inventory.armorItemInSlot(3) != null) {
				if (player.inventory.armorItemInSlot(3).getItem() == EvileDeferredRegistry.OVER_POWERED_AMETHYST_HELMET.get() && player.inventory.armorItemInSlot(2).getItem() == EvileDeferredRegistry.OVER_POWERED_AMETHYST_CHESTPLATE.get() && player.inventory.armorItemInSlot(1).getItem() == EvileDeferredRegistry.OVER_POWERED_AMETHYST_LEGGINGS.get()
