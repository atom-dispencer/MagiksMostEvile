...
public class ParticleClientStartup {
	...
	public static void onParticleFactoryRegistration(ParticleFactoryRegisterEvent event) {
		...
		MagiksMostEvile.LOGGER.warn("If this is the last thing you can see and Minecraft isn't loading, check in ParticleClientStartup for infinite loading loops.");
		Minecraft.getInstance().particles.registerFactory(EvileDeferredRegistry.GLYPH_PARTICLE.get(), sprite -> new GlyphParticleFactory(sprite));
