...
public class GlyphParticle extends SpriteTexturedParticle {
	 ...
	 */
	public GlyphParticle(World world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, Color tint, double diameter, IAnimatedSprite sprites) {
