...
public class AmethystSlimeEgg extends ItemMonsterPlacer
{
    @SideOnly(Side.CLIENT)
    private IIcon theIcon;
protected int colorBase = 0xb600ff;
protected int colorSpots = 0xfa00ff;
    protected String entityToSpawnName = "amethystSlime";
    protected String entityToSpawnNameFull = "";
    protected EntityLiving entityToSpawn = null;
    
    public AmethystSlimeEgg()
    {
        super();
    }
    
    public AmethystSlimeEgg(String parEntityToSpawnName, int parPrimaryColor, int parSecondaryColor)
    {
...
//                entityToSpawn.rotationYawHead = entityToSpawn.rotationY﻿aw;
...
@SideOnly(Side.CLIENT)
    ...
    public void setEntityToSpawnName(String parEntityToSpawnName)
    {
    	...
    	entityToSpawnNameFull = Main.MODID+"."+entityToSpawnName; // need to extend with name of mod

    }

     public void registerSpawnEgg(String parSpawnName, int parEggColor, int parEggSpotsColor)
     {
     Item itemSpawnEgg = new AmethystSlimeEgg(parSpawnName, parEggColor, parEggSpotsColor).setUnlocalizedName("spawn_egg_"+parSpawnName.toLowerCase()).setTextureName("magiksmostevile:spawn_egg");
