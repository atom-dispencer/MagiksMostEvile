...
public class ModelSpongie extends ModelBiped
{
    ...
    protected ModelSpongie(float p_i1167_1_, float p_i1167_2_, int p_i1167_3_, int p_i1167_4_)
    {
        super(p_i1167_1_, p_i1167_2_, p_i1167_3_, p_i1167_4_);
    }

    public ModelSpongie(float p_i1168_1_, boolean p_i1168_2_)
    {
