...
public class SpongieEgg extends ItemMonsterPlacer
{
    @SideOnly(Side.CLIENT)
    private IIcon theIcon;
protected int colorBase = 0x000000;
protected int colorSpots = 0xFFFFFF;
    protected String entityToSpawnName = "spongie";
    ...
    public SpongieEgg(String parEntityToSpawnName, int parPrimaryColor, int parSecondaryColor)
    {
...
@SideOnly(Side.CLIENT)
    ...
    public void setEntityToSpawnName(String parEntityToSpawnName)
    {
     ...
     {
     Item itemSpawnEgg = new SpongieEgg(parSpawnName, parEggColor, parEggSpotsColor).setUnlocalizedName("spawn_egg_"+parSpawnName.toLowerCase()).setTextureName("magiksmostevile:spawn_egg");
