...
public class EvileVampireBatAIWanderAvoidWaterFlying extends EntityAIBase {
	 ...
	 *                              true.
	 */	
	public EvileVampireBatAIWanderAvoidWaterFlying(EntityVampireBat creatureIn, double speedIn, int chanceOutOfIn) {
	...
	public boolean shouldContinueExecuting() {
		if (!(rand.nextInt(500) == 1)) {
			moveRandomly(vampireBatCreature);
			return true;
		} else {
			return false;
		}
	...
	private void moveRandomly(EntityVampireBat creature) {
